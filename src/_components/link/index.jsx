...
export function Link({
  ...
  const mobileButtonStyleCx =
    "hover:drop-shadow-button rounded border border-primary bg-primary p-2 md:p-0 font-sans font-bold uppercase text-white hover:translate-x-[3px] hover:translate-y-[-3px] md:border-none md:bg-transparent md:normal-case md:hover:transform-none md:hover:drop-shadow-none transition ease-in-out duration-500";
  const cx = twMerge(
