...
function Contact() {
  return (
    <div className="mb-32 flex w-full flex-col justify-between md:flex-row-reverse lg:flex-row">
      ...
      <div className="flex w-full flex-col lg:w-8/12">
        ...
        <div className="mb-8 w-full lg:w-6/12">
          <Paragraph>
            ...
            favorite dinner recipe, latest NWSL news, surfing, starting an herb
            garden, the best local WFH coffee spots in San Diego — I want to
            talk about it! <br /> <br /> Leave a message and let’s get the
            conversation going.
          </Paragraph>
        </div>
        <Form />
